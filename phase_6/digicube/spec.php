...
<head>
<title>Samsung Galaxy S21 Ultra 5G - Full phone specifications</title>
<script>
...
<style type="text/css">
	...
	background-position: -866px -7011px;
        ...
        <div class="article-info-line page-specs light border-bottom">
            ...
            <h1 class="specs-phone-name-title" data-spec="modelname">Samsung Galaxy S21 Ultra 5G</h1>
...
<a href=samsung_galaxy_s21_ultra_5g-pictures-10596.php><img alt="Samsung Galaxy S21 Ultra 5G
MORE PICTURES" src=https://fdn2.gsmarena.com/vv/bigpic/samsung-galaxy-s21-ultra-5g-.jpg></a>      
  </div>
  <ul class="specs-spotlight-features" style="overflow:hidden;">
    <li class="specs-brief pattern right"  >
      <span class="specs-brief-accent"><i class="head-icon icon-launched"></i><span data-spec="released-hl">  منتشر شده در </span></span><br>
      <span class="specs-brief-accent"><i class="head-icon icon-mobile2"></i><span data-spec="body-hl">227g (Sub6), 229g (mmWave), 8.9mm thickness</span></span><br>
      <span class="specs-brief-accent"><i class="head-icon icon-os"></i><span data-spec="os-hl">Android 11, One UI 3.1</span></span><br>
      <span class="specs-brief-accent"><i class="head-icon icon-sd-card-0"></i><span data-spec="storage-hl">128GB/256GB/512GB storage, no card slot</span></span>  
    ...
    <li class="help accented help-display">
      ...
      <strong class="accent"><span data-spec="displaysize-hl">6.8"</span></strong><div data-spec="displayres-hl">1440x3200 pixels</div>
    </li>
    <li class="help accented help-camera">
      <i class="head-icon icon-camera-1"></i>
      <strong class="accent accent-camera"><span data-spec="camerapixels-hl">108</span><span>MP</span>
      </strong> <div data-spec="videopixels-hl">4320p</div></li>

    <li class="help accented help-expansion">
      <i class="head-icon icon-cpu"></i>
      <strong class="accent accent-expansion"><span data-spec="ramsize-hl">8-16</span><span>GB RAM</span></strong> 
    ...
    <strong class="accent accent-battery"><span data-spec="batsize-hl">5000</span><span>mAh</span></strong><div data-spec="battype-hl">Li-Ion</div></li>
...
<li class="article-info-meta-link light"><a href=compare.php3?idPhone1=10596><i class="head-icon icon-mobile-phone231 icon-compare"></i>مقایسه</a></li>
...
<td class="nfo"  style="float:left" ><a href="#" class="link-network-detail collapse" style="margin-left: 80%;"   data-spec="nettech">GSM / CDMA / HSPA / EVDO / LTE / 5G</a></td>


</tr>
<tr class="tr-toggle">
<td class="ttl"><a href="network-bands.php3">2G </a></td>
<td class="nfo" data-spec="net2g"> </td>
</tr><tr class="tr-toggle" data-spec-optional>

</tr>
<tr class="tr-toggle">
<td class="ttl"><a href="network-bands.php3">  3G </a></td>
<td class="nfo" data-spec="net3g"> </td>
</tr>
...
<td class="nfo" data-spec="year"></td>
</tr>	
<tr>
...
<td class="nfo" data-spec="dimensions"></td>
</tr><tr>
...
<td class="nfo" data-spec="build"></td>
</tr>
<tr>
<td class="ttl"><a href="glossary.php3?term=sim">سیم کارت</a></td>
<td class="nfo" data-spec="sim"></td>
</tr>
<tr><td class="ttl">&nbsp;</td><td class="nfo" data-spec="bodyother"></td></tr>
...
<td class="nfo" data-spec="displaytype"></td>
</tr>
<tr>
<td class="ttl"><a href=# onClick="helpW('h_dsize.htm');">اندازه</a></td>
<td class="nfo" data-spec="displaysize"></td>
</tr>
<tr>
<td class="ttl"><a href="glossary.php3?term=resolution">وضوح</a></td>
<td class="nfo" data-spec="displayresolution"></td>
</tr>
<tr>
<td class="ttl"><a href="glossary.php3?term=screen-protection">فن آوری محافظ </a></td>
<td class="nfo" data-spec="displayprotection"></td>
</tr>
<tr><td class="ttl">&nbsp;</td><td class="nfo" data-spec="displayother"></td></tr>
...
<td class="nfo" data-spec="memoryslot"></td></tr>

	

<tr>
<td class="ttl"><a href="glossary.php3?term=dynamic-memory">حافظه  دستگاه</a></td>
<td class="nfo" data-spec="internalmemory"></td>
</tr>
	

<tr><td class="ttl">&nbsp;</td><td class="nfo" data-spec="memoryother">UFS <br />
</td></tr>
...
-->
	...
	<th rowspan="4" scope="row" class="small-line-height">دوربین اصلی</th>
		<td class="ttl"><a href="glossary.php3?term=camera">چهار لنز مجزا</a></td>
	<td class="nfo" data-spec="cam1modules"></td>
	</tr>
		<tr>
	<td class="ttl"><a href="glossary.php3?term=camera">امکانات</a></td>
	<td class="nfo" data-spec="cam1features"></td>
	</tr>
		<tr>
...
-->
	...
	<th rowspan="4" scope="row" class="small-line-height">دوربین سلفی</th>
		<td class="ttl"><a href="glossary.php3?term=secondary-camera">تک لنز</a></td>
	<td class="nfo" data-spec="cam2modules"></td>
	</tr>
		<tr>
	<td class="ttl"><a href="glossary.php3?term=secondary-camera">امکانات</a></td>
	<td class="nfo" data-spec="cam2features"></td>
	</tr>
		<tr>
	<td class="ttl"><a href="glossary.php3?term=secondary-camera">ویدیو</a></td>
...
<tr><td class="ttl">&nbsp;</td><td class="nfo" data-spec="optionalother"></td></tr>
...
<tr><td class="ttl">&nbsp;</td><td class="nfo" data-spec="featuresother"></td></tr>
...
<td class="nfo" data-spec="batdescription1"></td>
</tr>
<tr>
...
<td class="nfo" data-spec="models"></td>
</tr>


<tr>
<td class="ttl"><a href="glossary.php3?term=price">قیمت</a></td>
<td class="nfo" data-spec="price"><a href="samsung_galaxy_s21_ultra_5g-price-10596.php"></a></td>
</tr>
</table>
...
<a href="#" onclick="showBatteryPopup(event, 10596); "></a><div class="popover top" id="battery-popover" style="display: none;"></div>
</div>
</td>
</tr><tr>
